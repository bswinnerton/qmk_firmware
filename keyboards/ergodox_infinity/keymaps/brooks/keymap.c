 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      | LAlt | LAlt | LGui |                                       | RGui | RAlt | Left | Down | Rght |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | ESC  | Mute |       | Pl/Ps|  ESC |
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_TRNS,        KC_TRNS,  KC_LALT,  KC_LALT,  KC_LGUI,
...
/* Keymap 1: Basic layer with control as escape
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   `    |   1  |   2  |   3  |   4  |   5  | LAY0 |           | LAY2 |   6  |   7  |   8  |   9  |   0  |   =    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  |  [   |           |   ]  |   Y  |   U  |   I  |   O  |   P  |   -    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[ECTL] = KEYMAP(  // layer 0 : default
        ...
        // Right Hand
        KC_FN2,         KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_EQL,
        KC_RBRC,        KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_MINS,
                        KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
        KC_SLSH,        KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_UP,    KC_RSFT,
                                  KC_RGUI,  KC_RALT,  KC_LEFT,  KC_DOWN,  KC_RGHT,
...
[SYMB] = KEYMAP(
       // Left Hand
       M(0),            KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_FN1,
       ...
       // Right hand
       KC_FN2,          KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,
